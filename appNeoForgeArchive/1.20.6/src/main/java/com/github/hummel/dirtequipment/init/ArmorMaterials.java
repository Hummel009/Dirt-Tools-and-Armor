...
public class ArmorMaterials {
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> DIRT = REGISTRY.register("dirt", () -> material("dirt", new int[]{3, 6, 8, 3, 11}, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 2.0f, 0.0f, Ingredient.of(Items.DIRT)));
